...
public class StreetFighterCharSelectionTest {
    ...
    public void shouldWorkWithNoMoves() {
        ...
        assertEquals(solution, StreetFighterCharSelection.streetFighterSelection(fighters, new int[]{0,0}, new String[]{}));
    }
    ...
    public void shouldWorkWithFewMoves(){
        ...
        assertEquals(solution, StreetFighterCharSelection.streetFighterSelection(fighters, new int[] {0,0}, moves));
    }
